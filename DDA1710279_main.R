...
#1. High for  those who travelled frequently 
#2. High for HR Department 
#3. High for educational fields as HR
...
lift.obj <- performance(pred_object_test, measure="lift", x.measure="rpp")
plot(lift.obj,
...
library(gains)
gains.cross <- gains(actual=test_actual_attrition, predicted=test$prob/100,groups=10)
print(gains.cross)
